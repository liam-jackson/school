...
print('A polynomial OLS-fit of order 10 seems to have the best compromise of accuracy and economy of variables. A substantial reduction in error occurs from order-9 to order-10, with no substantial decrease with additional (11, 12, 13, 14) order terms.');
